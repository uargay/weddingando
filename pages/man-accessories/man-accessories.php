...
<head>
    ...
    <title>Wedding&Co. - Аксессуары для него</title>
    <link rel="stylesheet" href="man- accessories.css">
</head>
<body>
    <header>
        <div class="container">
    ...
    <main>
        <div class="container">
            <div class="catalog">
                ...
                <img src="../woman-dresses/img/dress-branch.svg" alt="" class="dress-branch">

                <p class="catalog__title">Аксессуары для него</p>
                    <div class="catalog__items">
                        
                    <?php 
                        $query = "SELECT * FROM man_accessories";
                        $results = mysqli_query($link, $query);
                            while ($row = $results->fetch_assoc()) {
                            echo '
                                <div class="catalog__item">
                                    <img src="'.$row["img"].'" class="catalog__item-photo" alt="Свадебное платье"></a>
                                    <p class="catalog__item-descr"><a href="../goods/man_accessories_goods/goods.php?accessories_id='.$row['id'].'">'.$row['name'].'</a></p>
