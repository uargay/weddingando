...
<head>
    ...
    <link rel="stylesheet" href="man-suit.css">
    <title>Wedding&Co. - Свадебные костюмы</title>
</head>
<body>
    <header>
        <div class="container">
    ...
    <main>
        <div class="container">
            <div class="catalog">
                ...
                <p class="catalog__title">Свадебные костюмы</p>
                    <div class="catalog__items">
                        
                    <?php

                        $query = "SELECT * FROM man_suits";
                        $results = mysqli_query($link, $query);
                        while ($row = $results->fetch_assoc()) {
                            echo '
                                <div class="catalog__item">
                                    <img src="'.$row["img"].'" class="catalog__item-photo" alt="Свадебное платье"></a>
                                    <p class="catalog__item-descr"><a href="../goods/man_suits_goods/goods.php?suits_id='.$row['id'].'">'.$row['name'].'</a></p>
