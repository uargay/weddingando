...
<head>
    ...
    <title>Wedding&Co. - Флористика</title>
    <link rel="stylesheet" href="floristica.css">
</head>
<body>
    <header>
        <div class="container">
    ...
    <main>
        <div class="container">
            <div class="catalog">
                ...
                <p class="catalog__title">Флористика</p>
                    <div class="catalog__items">
                        
                    <?php 

                        $query = "SELECT * FROM floristica";
                        $results = mysqli_query($link, $query);
                        while ($row = $results->fetch_assoc()) {
                            echo '
                                <div class="catalog__item">
                                    <img src="'.$row["img"].'" class="catalog__item-photo" alt="Свадебное платье"></a>
                                    <p class="catalog__item-descr"><a href="../goods/floristica_goods/goods.php?floristica_id='.$row['id'].'">'.$row['name'].'</a></p>
