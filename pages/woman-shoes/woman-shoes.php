...
<head>
    ...
    <title>Wedding&Co. - Женские туфли</title>
    <link rel="stylesheet" href="woman-shoes.css">
</head>
<body>
    <header>
        <div class="container">
            <nav class="nav">
                <div class="nav__logo">
                    <a href="../../index.html"><img src="icons/logo-white.svg" alt="логотип Wedding&Co."></a>
                </div>
        ...
        <main>
            <div class="container">
                <div class="catalog">
                    ...
                    <img src="../woman-shoes/img/shoes-branch.svg" alt="" class="shoes-branch">
    
                    <p class="catalog__title">Женские туфли</p>
                        <div class="catalog__items">
                            
                            <?php

                                $query = "SELECT * FROM woman_shoes";
                                $results = mysqli_query($link, $query);
                                while ($row = $results->fetch_assoc()) {
                                    echo '
                                        <div class="catalog__item">
                                            <img src="'.$row["img"].'" class="catalog__item-photo" alt="Свадебное платье"></a>
                                            <p class="catalog__item-descr"><a href="../goods/woman_shoes_goods/goods.php?shoes_id='.$row['id'].'">'.$row['name'].'</a></p>
