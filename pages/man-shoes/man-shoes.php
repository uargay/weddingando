...
<head>
    ...
    <title>Wedding&Co. - мужские туфли</title>
    <link rel="stylesheet" href="man-shoes.css">
</head>
<body>
    <header>
        <div class="container">
        ...
        <main>
            <div class="container">
                <div class="catalog">
                    ...
                    <p class="catalog__title">Мужские туфли</p>
                        <div class="catalog__items">
                            
                        <?php 

                            $query = "SELECT * FROM man_shoes";
                            $results = mysqli_query($link, $query);
                            while ($row = $results->fetch_assoc()) {
                                echo '
                                    <div class="catalog__item">
                                        <img src="'.$row["img"].'" class="catalog__item-photo" alt="Свадебное платье"></a>
                                        <p class="catalog__item-descr"><a href="../goods/man_shoes_goods/goods.php?shoes_id='.$row['id'].'">'.$row['name'].'</a></p>
