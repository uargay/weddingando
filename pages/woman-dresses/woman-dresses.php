...
<html lang="ru">
    <head>
        ...
        <link rel="stylesheet" href="woman-dresses.css">
        <title>Wedding&Co. - Свадебные платья</title>
    </head>
    <body>
        <header>
        <div class="container">
    ...
    <div class="container">
            <div class="catalog">
                ...
                <p class="catalog__title">Свадебные платья</p>
                    <div class="catalog__items">
                        
                    <?php

                            $query = "SELECT * FROM woman_dresses";
                            $results = mysqli_query($link, $query);
                            while ($row = $results->fetch_assoc()) {
                                echo '
                                    <div class="catalog__item">
                                        <img src="'.$row["img"].'" class="catalog__item-photo" alt="Свадебное платье"></img>
                                        <p class="catalog__item-descr"><a href="../goods/woman_dresses_goods/goods.php?dress_id='.$row['id'].'">'.$row['name'].'</a></p>
